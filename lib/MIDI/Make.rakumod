...
class Track is export {
    ...
    has UInt4  $.channel = 0;
    has UInt7  $.velocity-off = 0;
    has UInt7  $.velocity-on = 127;
    ...
    multi method velocity-off { $!velocity-off }
    multi method velocity-on  { $!velocity-on }
    ...
    multi method velocity-off ($velocity) { $!velocity-off = $velocity }
    multi method velocity-on  ($velocity) { $!velocity-on  = $velocity }
    ...
    method effect-control_2_MSB   (UInt7 $v) { self.controller( 13, $v) }
        # 14-15 are undefined.
    method general-control_1_MSB  (UInt7 $v) { self.controller( 16, $v) }
    method general-control_2_MSB  (UInt7 $v) { self.controller( 17, $v) }
    method general-control_3_MSB  (UInt7 $v) { self.controller( 18, $v) }
    method general-control_4_MSB  (UInt7 $v) { self.controller( 19, $v) }
        # 20-31 are undefined.
    ...
    method effect-control_2_LSB   (UInt7 $v) { self.controller( 45, $v) }
        # 46-47 are undefined.
    method general-control_1_LSB  (UInt7 $v) { self.controller( 48, $v) }
    method general-control_2_LSB  (UInt7 $v) { self.controller( 49, $v) }
    method general-control_3_LSB  (UInt7 $v) { self.controller( 50, $v) }
    method general-control_4_LSB  (UInt7 $v) { self.controller( 51, $v) }
        # 52-63 are undefined.
    ...
    method general-control_5      (UInt7 $v) { self.controller( 80, $v) }
    method general-control_6      (UInt7 $v) { self.controller( 81, $v) }
    method general-control_7      (UInt7 $v) { self.controller( 82, $v) }
    method general-control_8      (UInt7 $v) { self.controller( 83, $v) }
    method portamento-control     (UInt7 $v) { self.controller( 84, $v) }
        # 85-87 are undefined.
    method hi-res-velocity-prefix (UInt7 $v) { self.controller( 88, $v) }
        # 89-90 are undefined.
    ...
    method general-control_1 (UInt14 $v) {
        self.general-control_1_MSB(self!MSB($v));
        self.general-control_1_LSB(self!LSB($v));
    }
    method general-control_2 (UInt14 $v) {
        self.general-control_2_MSB(self!MSB($v));
        self.general-control_2_LSB(self!LSB($v));
    }
    method general-control_3 (UInt14 $v) {
        self.general-control_3_MSB(self!MSB($v));
        self.general-control_3_LSB(self!LSB($v));
    }
    method general-control_4 (UInt14 $v) {
        self.general-control_4_MSB(self!MSB($v));
        self.general-control_4_LSB(self!LSB($v));
    }
